...
import { Bell, Menu, UserCheck, Shield, CheckCircle2, AlertCircle, LogOut, LogIn, Store, User } from 'lucide-react';
...
const PAGE_TITLES: Record<string, { title: string; subtitle: string }> = {
  ...
  '/settings': { title: 'System Settings', subtitle: 'Platform and store configuration' },
